...
export function PricingCard({
  ...
  const upgradeMutation = useMutation({
    mutationFn: async (name: string) => {
      ...
      // Create a subscription for the server
      const result = await authClient.subscription.upgrade({
        plan: name,
        referenceId: activeServer.id,
        annual: false,
        successUrl: `/servers/${activeServer.slug}/settings/billing/success`,
        cancelUrl: `/servers/${activeServer.slug}/settings/billing`,
      });
